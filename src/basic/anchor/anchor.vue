    ...
    <Transition>
      <div class="item" v-show="isShow">
        <el-anchor :offset="70" direction="horizontal">
          <el-anchor-link :href="`#${locale['JS-Object']}`">
            {{ locale["JS-Object"] }}
          </el-anchor-link>
          <el-anchor-link :href="`#${locale['JS-Array']}`">
            {{ locale["JS-Array"] }}
          </el-anchor-link>
          <el-anchor-link :href="`#${locale['JS-function']}`">
            {{ locale["JS-function"] }}
          </el-anchor-link>
        </el-anchor>
      </div>
...
import anchorLocale from "../anchor/anchor.json";
