<template>
  <div class="w-40 mb-0 mt-[-30px] ml-10" style="display: flex; align-items: center;">
    <svg
      version="1.1"
      id="Layer_1"
      ...
      style="enable-background: new 0 0 121.9 121.9;width: 48px;height: 48px; "
      xml:space="preserve"
    >
      <g>
        <path class="path1" :fill='"#949393"'
          d="M94.2,5.6C88.3-5,78.3,17.1,76.2,21.7c-4.4,10-7.3,20.1-9.6,30.7c-2.6-2.8-4.4-6.1-6.4-9.3c-1.1-2-1.6-7.8-4.9-4.8
